...
- - You may need to turn file extensions on in your file explorer (Windows Explorer, Finder, etc)
...
kmtcars = kmtcars %>% select(model, everything()) # Make a new data table, where the model name comes first, then have all other rows in their original order
